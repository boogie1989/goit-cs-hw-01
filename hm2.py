...
class Lexer:
    ...
    def get_next_token(self):
        while self.current_char is not None:
            ...
            raise LexicalError("Невідомий символ: {}".format(self.current_char))
...
def test_expressions():
    ...
    for expression, expected in test_cases:
        try:
            ...
            print(f"Test passed for '{expression}': Correctly computed {result}")
        except AssertionError as e:
            print(e)
            errors += 1
        except Exception as e:
            print(f"An error occurred while testing '{expression}': {str(e)}")
            errors += 1

    if errors == 0:
        print("All tests passed!")
    else:
        print(f"There were {errors} errors in the test cases.")
